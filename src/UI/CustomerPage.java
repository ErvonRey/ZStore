...
public class CustomerPage extends javax.swing.JFrame {
    ...
    public CustomerPage() {
        initComponents();
        loadData();         //loads the customer's data
        loadOrderData();    //loads the customer's past orders
    }
    
    //calls the Functions method since the customer might wanna update his information
    ...
    //loads the old orders from the customer
    ...
    //will "delete" the user's credentials for login.
    ...
    //deletes the customer's previous orders... All orders.
